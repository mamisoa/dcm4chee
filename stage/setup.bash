...
# apt-get install -y curl zip openjdk-6-jdk
...
# copy imageio-1.1lib
curl -G http://download.java.net/media/jai-imageio/builds/release/1.1/jai_imageio-1_1-lib-linux-amd64.tar.gz > /stage/jai_imageio-1_1-lib-linux-amd64.tar.gz
tar -xvf /stage/jai_imageio-1_1-lib-linux-amd64.tar.gz jai_imageio-1_1/lib/libclib_jiio.so -C /stage/
cp /stage/libclib_jiio.so $DCM_DIR/bin/native
